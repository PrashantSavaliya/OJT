var $FNameLNameRegEx = /^([a-zA-Z]{2,20})$/;
        ...
        $(document).ready(function () {
            ...
            var TxtNameFlag = false,TxtLNameFlag=false ,TxtContactNoFlag = false, TxtEmailIdFlag = false;
            ...
            $("#BtnSubmit").click(function () {
                ...
                if ($("#TxtLName").val() == "" || $("#TxtLName").val() == null) {
                    ...
                    if (!$("#TxtLName").val().match($FullNameRegEx)) {
                        $("#TxtNameValidation").html("(*) Invalid name..!!");
                        TxtLNameFlag = false;
                    }
                    else {
                ...
                if (TxtNameFlag == true && TxtLNameFlag==true && TxtContactNoFlag == true && TxtEmailIdFlag == true) {
                    $("input,textarea").val("");
